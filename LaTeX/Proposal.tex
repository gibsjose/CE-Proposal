...
are suggested based on suggestions drawn from the inferences and
...
\item To emphasize the importance of certain topics that are currently \textbf{not} part of the curriculum
...
be hosted on other sites such as Gitlab (www.gitlab.com) or Bitbucket
(www.bitbucket.org), both of which offer free private repositories.
\bigskip
